...
const BookDetailPage: React.FC = () => {
  ...
  }, [chapters, downloadTasks, book?.id, cachedChapters.size]);
  ...
  }, [book, currentChapter, mainChapters, extraChapters, activeTab, currentGroupIndex, currentChapters, chaptersPerGroup]);
  ...
  const handleScrape = async () => {
    ...
    try {
      ...
      console.error('Failed to scrape book', err);
      alert('刮削失败');
    } finally {
      setScraping(false);
    }
  ...
  const handleSelectAll = () => {
    ...
    // Actually we should select all from the current tab list
